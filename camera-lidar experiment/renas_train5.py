...
TEST VERSION WITHOUT GPT only pose
'''
...
class Renas(torch.nn.Module):
    ...
    def forward(self, map, costmap, mapinfo, pose):
        ...
        tokens = self.mid_transformer(tokens)[:, 0, :].view(m1, m2, -1)
...
def ddp_train_loop(rank, world_size, train_dataset, test_dataset):
    ...
    while True:
        ...
        for i, batch in enumerate(train_dataloader):
            ...
            output = model(map, costmap, mapinfo, pose)
