...
class Renas9forTrain(torch.nn.Module):
    ...
    def forward(self, batch, act_vocab_coords, act_vocab_im, act_vocab_prompt, act_vocab_map):
...
def train_loop(train_dataset, test_dataset, act_vocab_coords, act_vocab_im, act_vocab_prompt, act_vocab_map):
    ...
    while True:
        ...
        for i, batch in enumerate(train_dataloader):
            output = model(batch, act_vocab_coords, act_vocab_im, act_vocab_prompt, act_vocab_map)
